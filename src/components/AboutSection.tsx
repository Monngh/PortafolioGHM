  ...
  return (
    <section ref={ref} className="bg-black pt-32 md:pt-44 pb-10 md:pb-14 px-6 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        >
          Pioneering <em className="font-heading italic text-white/60">ideas</em> for<br className="hidden md:block" />
          minds that <em className="font-heading italic text-white/60">create, build, and inspire.</em>
        </motion.h2>
      </div>
    </section>
  );
