...
export function PhilosophySection() {
  ...
  return (
    <section ref={ref} className="bg-black py-28 md:py-40 px-6 overflow-hidden flex justify-center w-full">
      <div className="max-w-6xl w-full">
        ...
        >
          Innovation <em className="font-heading italic text-white/40">x</em> Vision
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full">
          ...
          <motion.div 
            ...
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="flex flex-col justify-center gap-10 text-left"
          >
            <div>
